...
class ResourceLoader {
	...
	protected function filter( $filter, $data ) {
		global $wgResourceLoaderMinifierStatementsOnOwnLine, $wgResourceLoaderMinifierMaxLineLength, $wgResourceLoaderCacheType;
		...
		$cache = wfGetCache( $wgResourceLoaderCacheType );
